...
const Header: React.FC<HeaderProps> = ({ onLogoClick }) => {
    return (
        <header className="mb-4 flex flex-row justify-between items-end gap-2 border-b border-slate-800 pb-3">
            ...
            >
                <div className="bg-yellow-500 text-black font-black px-1.5 py-0.5 rounded-[2px] text-[8px] md:text-[10px] italic w-fit mb-0.5 uppercase leading-none">Kyo-Pre! AI Manager</div>
                <h1 className="text-xl md:text-3xl font-black tracking-tighter uppercase leading-none">Meta-Matrix <span className="text-yellow-500">ND</span></h1>
            </div>
